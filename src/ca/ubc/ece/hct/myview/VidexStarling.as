...
//        } else if((survey_so.size == 0 /* so didn't exist */ || survey_so.data.survey2018 == undefined || survey_so.data.survey2018 == false) &&
//                CONFIG::Instructor == false) {
//            surveyPopup = new SurveyPopup(UserID.id, "https://ubc.ca1.qualtrics.com/jfe/form/SV_034BXFlB8vXJsu9", "VIDEXSURVEY2018");
//            surveyPopup.closeMeSignal.add(function(surveyCompleted:Boolean):void {
//                if(surveyCompleted) {
//                    survey_so.data.survey2018 = true;
