 ...
 */
public class StarlingNativeSignal implements StarlingINativeDispatcher
{
     ...
     */
    public function StarlingNativeSignal(target:EventDispatcher = null, eventType:String = "", eventClass:Class = null)
    {
        slots = SlotList.NIL;
        this.target = target;
